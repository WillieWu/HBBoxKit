...
public extension Date {
    ...
    public func time_decode() -> String {
        ...
        if self.isInCurrentYear {
            ...
            if self.isInCurrentMonth {
                ...
                if self.isInYesterday {
                    ...
                    return "昨天 " + self.string(withFormat: "HH:mm")
                    
                }else if self.isInToday {
                    
                    let hour = Date(timeIntervalSinceNow: 0).hoursSince(self)
                    
                    if Int(hour) == 0 {
                        
                        let minute = Date(timeIntervalSinceNow: 0).minutesSince(self)
                    ...
                    let day = Date(timeIntervalSinceNow: 0).daysSince(self)
                    return "\(Int(day))天前 " + self.string(withFormat: "HH:mm")
                    
                }
                
            }else{
                
                return self.string(withFormat: "MM-dd HH:mm")
            }
    ...
    public func time_yyyyMMdd() -> String {
        
        if self.isInCurrentYear {
            
            
            return self.string(withFormat: "MM-dd")
